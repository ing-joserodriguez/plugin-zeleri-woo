...
class Zeleri_Woo_Oficial_Payment_Gateways extends WC_Payment_Gateway {
    ...
    public function process_payment($order_id) {
        try {
            ...
            var_dump($e);
            //wc_add_notice('Error processing payment: ' . print_r($e->getMessage(), true), 'error');
            throw new Exception('Payment processing failed.', 0, $e->get_error_message()); // Re-throw exception with more context
        }
    }
