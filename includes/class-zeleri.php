...
class Zeleri {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Zeleri_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'ZELERI_VERSION' ) ) {
			$this->version = ZELERI_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'zeleri';
	 ...
	 *
	 * - Zeleri_Loader. Orchestrates the hooks of the plugin.
	 * - Zeleri_i18n. Defines internationalization functionality.
	 * - Zeleri_Admin. Defines all hooks for the admin area.
	 * - Zeleri_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-zeleri-loader.php';
	 ...
	 *
	 * Uses the Zeleri_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Zeleri_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Zeleri_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Zeleri_Loader    Orchestrates the hooks of the plugin.
	 */
